...
public class GroupDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.ac_ll_search_chatting_records) {
        ...
        } else if (i == R.id.group_announcement) {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        } else if (i == R.id.sw_group_notfaction) {
            if (isChecked) {
                if (mGroup != null) {
